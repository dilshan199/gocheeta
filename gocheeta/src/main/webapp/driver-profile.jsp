...
<html lang="en">
	<head>
		...
		<title>GoCheeta - Driver Profile</title>
	</head>
	<body>
    									...
    									<div class="row">
    										<div class="col-6">
    											<div class="form-group mb-3">
    												...
    												<input type="text" class="form-control" readonly value="<tag:out value='${dl.firstName}'></tag:out>" />
    											</div>
    										</div>
    										<div class="col-6">
    											<div class="form-group mb-3">
    												<label for="lastName">Last Name</label>
    												<input type="text" class="form-control" readonly value="<tag:out value='${dl.lastName}'></tag:out>" />
    											</div>
    										</div>
    										<div class="col-6">
    											<div class="form-group mb-3">
    												<label for="nic">NIC(Username)</label>
    												<input type="text" class="form-control" readonly value="<tag:out value='${dl.nic}'></tag:out>" />
    											</div>
    										</div>
    										<div class="col-6">
    											<div class="form-group mb-3">
    												<label for="contactNo">Contact No</label>
    												<input type="tel" class="form-control" readonly value="<tag:out value='${dl.contactNo}'></tag:out>" />
    											</div>
    										</div>
    									</div>
    								</div>
    												...
    												<tbody>
    													<tag:forEach var="booking" items="${bookingList}">
    														<tr>
    															...
    															<td><tag:out value="${booking.pickUpDate}"></tag:out></td>
    															...
    															<td>
    																<a href="readmore?bookingId=<tag:out value='${booking.bookingId}'></tag:out>" class="btn btn-outline-secondary btn-sm">Read More</a>
    															</td>
    														</tr>
    													</tag:forEach>
    												</tbody>
