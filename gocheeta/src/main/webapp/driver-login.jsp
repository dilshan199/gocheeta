...
<html lang="en">
	<head>
		...
		<title>GoCheeta - Driver Login</title>
	</head>
	<body>
				...
				<div class="container-fluid register-inner">
					<div class="row">
						...
						<div class="col-12 col-sm-12 col-md4 col-lg-4 col-xl-4">
							<form action="driverlogin?type=submit" method="post" class="mt-3">
								<div class="form-group mb-2">
									<label for="nic" class="form-label">NIC <span class="text-danger">*</span></label>
									<input type="text" name="nic" id="nic" class="form-control" autocomplete="off" value="" />
